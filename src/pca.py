...
def princomp(A):
    """ performs principal components analysis
     ...
     Returns :  
      coeff :
        is a p-by-pfrom numpy import mean,cov,double,cumsum,dot,linalg,array,rank
    from pylab import plot,subplot,axis,stem,show,figure
     matrix, each column containing coefficients 
...
## testing pca with my spectrum database

from numpy import genfromtxt
rowdata = genfromtxt('C:/Users/David/Desktop/Muzi work/tesnorflow training and testing data/bigdataamaskplusantimask2700final.csv', delimiter=',')

coeff, score, latent = princomp(rowdata)


import numpy

numpy.savetxt("coeffPCApython.csv", coeff, delimiter=",")
numpy.savetxt("scorePCApython.csv", score, delimiter=",")
